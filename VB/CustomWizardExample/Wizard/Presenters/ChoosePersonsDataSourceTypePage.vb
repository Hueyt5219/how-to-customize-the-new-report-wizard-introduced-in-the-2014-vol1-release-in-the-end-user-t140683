...
Namespace CustomWizardExample.Wizard.Presenters
	Public Class ChoosePersonsDataSourceTypePage
		Inherits WizardPageBase(Of Views.IChoosePersonsDataSourcePageView, Model.CustomReportModel, IDataSourceWizardClient)

		Public Sub New(ByVal view As Views.IChoosePersonsDataSourcePageView, ByVal client As IDataSourceWizardClient)
		...
		Public Overrides Function GetNextPageType() As Type
			Return GetType(SelectColumnsPage(Of Model.CustomReportModel, IDataSourceWizardClient))
		End Function
