Namespace CustomWizardExample.Wizard.Views
	Partial Public Class ChoosePersonsDataSourcePageView
		...
		Private Sub InitializeComponent()
            ...
            Me.rgDataSourceType.Properties.Items.AddRange(New DevExpress.XtraEditors.Controls.RadioGroupItem() {New DevExpress.XtraEditors.Controls.RadioGroupItem(Nothing, "Load Persons from Data.xml"), New DevExpress.XtraEditors.Controls.RadioGroupItem(Nothing, "Use static list of Persons from the application")})
        ...
        End Sub
        Private WithEvents rgDataSourceType As DevExpress.XtraEditors.RadioGroup
