...
Namespace CustomWizardExample
	...
	Public Class PersonsSource
		...
		Public Function GetStaticPersons() As IList(Of Person)
			Return New List(Of Person)(New Object() { New Person() With {.FirstName = "John", .SecondName = "Abbot"}, New Person() With {.FirstName = "Paul", .SecondName = "Bass"}, New Person() With {.FirstName = "George", .SecondName = "Chance"}})
		End Function
	End Class
End Namespace
