...
#End Region
        ...
        Private Sub OnNewReportWizard()
            ...
            mdiController.Form.BeginInvoke(New MethodInvoker(Sub()
                                                                 ...
                                                                 Dim myMethod As System.Action = Sub() CType(New WizardReportBuilder(designerHost), WizardReportBuilder).Build(runner.WizardModel, True, CreateDataComponent(runner.WizardModel))
